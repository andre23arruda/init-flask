...
def traduz_jogos(jogos):
    '''Transforma resultado da pesquisa no banco em uma lista'''
    def cria_jogo_com_tupla(tupla):
        '''Cria objeto jogo com informações da tupla'''
        return Jogo(tupla[1], tupla[2], tupla[3], tupla[0])
    return list(map(cria_jogo_com_tupla, jogos))


def traduz_usuario(tupla):
    '''Transforma resultado da pesquisa no banco em umm objeto Usuario'''
